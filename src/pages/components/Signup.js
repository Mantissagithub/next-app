...
function Signup() {
    ...
    return (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: {
                    ...
                    justifyContent: "center"
                }, children: (0, jsx_runtime_1.jsx)(material_1.Typography, { variant: "h6", children: "Welcome to Coursera. Sign up below" }) }), (0, jsx_runtime_1.jsx)("div", { style: { display: "flex", justifyContent: "center" }, children: (0, jsx_runtime_1.jsxs)(material_1.Card, { variant: "outlined", style: { width: 400, padding: 20 }, children: [(0, jsx_runtime_1.jsx)(TextField_1.default, { onChange: function (event) {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, axios_1.default.post("http://localhost:3000/admin/signup", {
                                                username: email,
                                                password: password
                                            })];
                                        case 1:
